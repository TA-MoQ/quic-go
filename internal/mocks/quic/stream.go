...
// Source: github.com/TA-MoQ/quic-go (interfaces: Stream)
//
// Generated by this command:
//
//	mockgen.exe -typed -build_flags=-tags=gomock -package mockquic -destination quic/stream.go github.com/TA-MoQ/quic-go Stream
//
