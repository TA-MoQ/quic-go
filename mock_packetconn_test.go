...
//
//	mockgen.exe -typed -package quic -self_package github.com/TA-MoQ/quic-go -self_package github.com/TA-MoQ/quic-go -destination mock_packetconn_test.go net PacketConn
//
