...
//
//	mockgen.exe -typed -package quic -self_package github.com/TA-MoQ/quic-go -source sys_conn_oob.go -destination mock_batch_conn_test.go -mock_names batchConn=MockBatchConn
//
