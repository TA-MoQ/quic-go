...
// Source: github.com/TA-MoQ/quic-go/http3 (interfaces: QUICEarlyListener)
//
// Generated by this command:
//
//	mockgen.exe -typed -package http3 -destination mock_quic_early_listener_test.go github.com/TA-MoQ/quic-go/http3 QUICEarlyListener
//
